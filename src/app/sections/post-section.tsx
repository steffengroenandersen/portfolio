    ...
    <>
      <section className="bg-white rounded-xl border">
        ...
        <div className="px-5 py-2">
          <p className="text-sm">
            I created a webapp that can help e-commerce companies check basic, but vital settings in their
            Meta Business Assets which can help prevent them getting hacked and waste money.
            <br />
            <br />
            It was very interesting to implement authentication using the{" "}
            <a href="https://thecopenhagenbook.com/" className="text-blue-600">
              The Copenhagen Book guide
            </a>{" "}
            and integrate with Meta through OAuth2.
            <br />
            <br />
            <ol>
              <li>
                <b>Frontend: </b>Svelte, TypeScript, Tailwind
              </li>
              <li>
                <b>Backend: </b>SvelteKit
              </li>
              <li>
                <b>Database: </b> SQL, PostgreSQL
              </li>
              <li>
                <b>DevOps: </b> Docker, Github Actions, Hetzner
              </li>
            </ol>
            Github repo not public as the project is deployed, but I can grant access.
          </p>
        </div>
        <div>
          <Image src={`${basePath}/markindex.png`} alt="Portfolio Page" width={1024} height={1024} />
        </div>
